      ...
      <div class="contact-us">
        ...
        <div class="contactcontent">
          ...
          <div class="presspartner">
            ...
            <br />
            <a
              href="mailto:hello@vogueluxuryevents"
              class="css-1jq0uo9 ejlpgkq0"
              data-projection-id="203"
            >
              hello@vogueluxuryevents.com
            </a>
          </div>
          ...
          <div class="contact-carear">
            <h2>Careers</h2>
            <p>
              Thank you for considering Vogue Luxury Events for your luxury
              event planning needs. We look forward to hearing from you and
              helping you create a celebration that you and your guests will
              remember for years to come.
            </p>
            <a
              href="mailto:hello@vogueluxuryevents.com"
              class="css-1jq0uo9 ejlpgkq0"
              data-projection-id="203"
            >
              hello@vogueluxuryevents.com
          ...
          <div className="contactForm">
            <div className="left">
              ...
              <p style={{ marginBottom: "20px", fontSize: "13px" }}>
                PLEASE COMPLETE THE FORM BELOW, INCLUDING AS MUCH INFORMATION AS
                POSSIBLE REGARDING THE EVENT.
              </p>
              <form>
